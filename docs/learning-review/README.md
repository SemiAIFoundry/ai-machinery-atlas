...
Use the [published v1.3.0 build](https://github.com/SemiAIFoundry/ai-machinery-atlas/releases/tag/v1.3.0) or a separately served candidate for sessions, and record its `build-info.json`. Scenario fixtures and written responses belong to the reviewed candidate's declared content, check and model versions.

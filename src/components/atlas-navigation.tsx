...
export default function AtlasNavigation(p:Props){
 ...
 return <div className="atlas-navigation">
  ...
  <button className="atlas-about" onClick={()=>p.onModal('glossary')}>Glossary &amp; units</button><button className="atlas-about" onClick={()=>p.onModal('about')}>How to read this atlas</button>
 </div>;
}
